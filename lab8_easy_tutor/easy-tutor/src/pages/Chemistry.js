...
function Chemistry() {
    ...
    return (
        <div>
            <div className="chemistryHeader">
                <h1>Chemistry Tutors</h1>
                <br></br>
                <h4>Book a session instantly.</h4>
            </div>
            <div id="chemistryTutors" className="row text-center">
                <div class="col-lg-4">
                    <div class="team-member">
                        <img class="img-thumbnail" src="images/chris-evans.jpg" alt="" />
                        <div class="employee-name">
                            <h4>Chris</h4>
                            <p class="text-muted">Hourly rate: $16/hour <br></br> Teaching experience: 2 years</p>
                ...
                <div class="col-lg-4">
                    <div class="team-member">
                        <img class="img-thumbnail" src="images/hannah-nelson.jpg" alt="" />
                        <div class="employee-name">
                            <h4>Hannah</h4>
                ...
                <div className="col-lg-4">
                    <div className="team-member">
                        <img class="img-thumbnail" src="images/nathan.jpg" alt="" />
