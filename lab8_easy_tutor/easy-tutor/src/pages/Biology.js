...
function Biology() {
    ...
    return (
        ...
        <div>
            <div className="biologyHeader">
                <h1>Biology Tutors</h1>
                <br></br>
                <h4>Book a session instantly.</h4>
            </div>
            <div id="biologyTutors" className="row text-center">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="team-member">
                        <img class="img-thumbnail" src="images/katherine-holmes.jpg" alt="" />
                        <div class="employee-name">
                            <h4>Kathy</h4>
